...
describe('Recommendation Engine', function () {
  ...
  describe('calculateAgreement', function () {
    ...
    it('returns a number between 0 and 1 for users who agree and disagree on some items.', function () {
      var user1 = {id: 1, likes: [1,2,4,8,10], dislikes: [5,7,6,3,9]}
      var user2 = {id: 2, likes: [2,3,1,9], dislikes: [4,5,6,7,8,10]}
      expect(calculateAgreement(user1, user2)).to.equal(0.5)
    })
  ...
  describe('calculateSimilarity', function () {
   ...
   it('returns 1.0 for users who like and dislike the same items', function () {
    ...
    it('returns 0.0 for users who agree and disagree on same number of items', function () {
      var user1 = {id: 1, likes: [1,2,4,8,10], dislikes: [5,7,6,3,9]}
      var user2 = {id: 2, likes: [2,3,1,9], dislikes: [4,5,6,7,8,10]}
      expect(calculateAgreement(user1, user2)).to.equal(0.0)
    })
